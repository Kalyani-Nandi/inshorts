...
const NewsCard = ({ article,handleCardClick }) => {
  ...
  return (
    <div onClick={()=>handleCardClick(article)} className="max-w-4xl mx-auto mb-6 rounded shadow-md overflow-hidden border bg-white hover:cursor-pointer md:p-2 md:flex">
